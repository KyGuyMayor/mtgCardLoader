...
import { Home, CardSearch, CardView, SetSearch, SetView, Login, Register, ForgotPassword, ResetPassword, CollectionsDashboard, CollectionDetail, GrandCollection, SharedCollectionView, ProtectedRoute } from './components';
  ...
  <Router>
    <AuthProvider>
      <Routes>
        ...
        <Route path="/collections/grand" element={<ProtectedRoute><GrandCollection /></ProtectedRoute>} />
